...
import { useNodeTestLogsPaginated, useNodeUpdateLog } from "@/src/lib/queries/node-log-queries"
                ...
                <Card className="flex-1 overflow-hidden">
                    <CardContent className="p-0">
                        <div className="border-b bg-muted/50">
                            <div className="grid grid-cols-[140px_90px_1fr] gap-3 px-4 py-3 font-medium text-sm">
                                <div>时间</div>
                                <div>状态</div>
                                <div>日志内容</div>
                            </div>
                                ...
                                <div className="divide-y">
                                    {logs.map((log) => {
                                        ...
                                        return (
                                            <div
                                                key={log.id}
                                                className="grid grid-cols-[140px_90px_1fr] gap-3 px-4 py-3 text-sm hover:bg-muted/50"
                                            >
